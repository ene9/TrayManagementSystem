...
BEGIN_MESSAGE_MAP(CTraySysView, CFormView)
	ON_WM_CONTEXTMENU()
	ON_WM_RBUTTONUP()
	ON_BN_CLICKED(IDC_RADIO1, &CTraySysView::OnBnClickedRadio1)
	ON_BN_CLICKED(IDC_RADIO2, &CTraySysView::OnBnClickedRadio2)
	ON_BN_CLICKED(IDC_RADIO3, &CTraySysView::OnBnClickedRadio3)
	ON_BN_CLICKED(IDC_RADIO4, &CTraySysView::OnBnClickedRadio4)
END_MESSAGE_MAP()
...
void CTraySysView::OnBnClickedRadio1()	// Slot1
{
	
}


void CTraySysView::OnBnClickedRadio2()	// Slot2
{
	
}


void CTraySysView::OnBnClickedRadio3()	// Slot3
{
	
}


void CTraySysView::OnBnClickedRadio4()	//Slot4
{
